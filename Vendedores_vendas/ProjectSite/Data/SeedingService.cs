...
using ProjectSite.Models.Enums;

namespace ProjectSite.Data
{
    public class SeedingService  // Fazendo injeção de dependência
    {
        private ProjectSiteContext _context;

        public SeedingService(ProjectSiteContext context)
        {
            _context = context;
        }
        ...
        public void Seed()      // Responsável por popular a base de dados.
        {
            ...
            Department d1 = new Department(1, "Computers");  // Primeiro objeto do tipo department
            ...
            Seller s6 = new Seller(6, "Alex Pink", "alexp@gmail.com", new DateTime(1997, 3, 4), 300.0, d2);
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // AddRange permite adicionar varios objetos de uma só verz
